...
class EventEditnew extends StatefulWidget {
  final int? eventId;
  final bool isNew;
  const EventEditnew({Key? key,required this.eventId,required this.isNew}) : super(key: key);
  @override
...
//print(response.body);
          ...
          if (masjids.length > 0) {
            Keyvaleus.add ( new KeyValue( key: "0",
                value: "Please Select masjid" ));
            for (int i = 0; i < masjids.length; i++) {
              Keyvaleus.add (
                  new KeyValue( key: masjids[i].Id.toString(), value: masjids[i].Name ) );
            }
    ...
    return SafeArea(
      child: Scaffold(
          ...
          appBar: AppBar(
            ...
            centerTitle: true,
            title: widget.isNew==false? Text("Edit Event",
              style: TextStyle(fontSize: 20,color: appColor,fontWeight: FontWeight.normal),):
            Text("Add Event",
              style: TextStyle(fontSize: 20,color: appColor,fontWeight: FontWeight.normal),),
          ),
              ...
              child: Column(
                ...
                children: [
                 ...
                 const Padding(
                    ...
                    child: Align(
                        alignment: Alignment.centerLeft,
                        child: Text("Masjid Name",style: BlackTextStyleNormal16,)),
                  ),
                  Padding(
                  ...
                  Padding(
                    ...
                    child: AddScreenTextFieldWidget(
                      ...
                      textName:  event.name.toString(),  inputType: TextInputType.name,
                      validator: (text) {
                  ...
                  Padding(
                    ...
                    // GetAddressFromLatLong(position);
                      ...
                      labelText: "Location",
                      obsecureText: false,
                      controller: TextEditingController(text:Address=='search'?locationController.text: Address),
                  ...
                  Padding(
                    ...
                    child: AddScreenTextFieldWidget(
                      ...
                      textName: event.description.toString(),  inputType: TextInputType.name,
                      validator: (text) {
                        if (!(text!.length > 5) && text.isEmpty) {
                        ...
                        if(!widget.isNew) {
                          event= Event.withId (
                            ...
                            location: locationController.text,
                              masjiId: int.parse(dropdown.seletected_value!.key),
