...
class TreeNodeData extends NodeData {
  ...
  TreeNodeData({this.label, this.color, this.receivingPropertyListTile}) : super();
...
//    _controller.insertAtIndex(1, dataNode, newNode);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _isSuccess ? getBody(mapBody) : getProgressView(),
    );
  }
            ...
            children: <Widget>[
              ...
              Visibility(
                ...
                child: InkWell(
                  onTap: () {
                    // Navigator.push(
                    //     context, MaterialPageRoute(builder: (context) =>   OrganizationEdit()));
                  },
                  child: FaIcon(
              ...
              Visibility(
                ...
                child: InkWell(
                  onTap: () {
                   if(group['children'].toString()!=null){
                     Text(group['children'].toString());
                     add(item);
                   }
